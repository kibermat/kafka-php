...
create function er.f_mis_profiles8add(pn_ext_id bigint, pu_profile_uid uuid, ps_name text, ps_match_profile text,
...
create function er.f_mis_profiles8upd(pn_id bigint, pn_ext_id bigint, pu_profile_uid uuid, ps_name text,
